...
def renderTemplate(template_file : str, **kwargs : Any) -> str:
...
def openOrCreateEmailDatabase(db_name : str) -> tuple[sqlite3.Connection, sqlite3.Cursor]:
...
def openOrCreateEmailWorkbook(filename : str):
...
class EmailMessages(Messages):
    ...
    def send(self):
        ...
        """        
        html_body = renderTemplate("email_messages_template.html",
...
class AutomateEmailMessage(Messages):
    ...
    def send(self):
        ...
        """        
        html_body = renderTemplate("automate_email_message_template4.html",
            subject             = "Your Learning Dreams Visit Confirmation",
            company_name        = "Learning Dreams",
...
if __name__ == "__main__":
    ...
    conn, cursor = openOrCreateEmailDatabase(FILENAME)
